...
// Reviewers
import UserReview1 from '../assets/img/feedback/reviewer_1.webp'
import UserReview2 from '../assets/img/feedback/reviewer_2.webp'
import UserReview3 from '../assets/img/feedback/reviewer_3.webp'
import UserReview4 from '../assets/img/feedback/kakashi.webp'
import UserReview5 from '../assets/img/feedback/obito.webp'
                          ...
                          <div className="col-12 swiper-slide">
                            <div className="d-flex justify-content-center gap-2">
                              <div className="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-1">
                                <div className="text-center text-lg-start"><img className="card-image rounded-circle object-fit-cover" src={UserReview1} alt="" /></div>
                          ...
                          <div className="col-12 swiper-slide">
                            <div className="d-flex justify-content-center gap-2">
                              <div className="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-2">
                                <div className="text-center text-lg-start"><img className="card-image rounded-circle object-fit-cover" src={UserReview2} alt="" /></div>
                                <div className="text-center text-lg-start">
                          ...
                          <div className="col-12 swiper-slide">
                            <div className="d-flex justify-content-center gap-2">
                              <div className="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-3">
                                <div className="text-center text-lg-start"><img className="card-image rounded-circle object-fit-cover" src={UserReview3} alt="" /></div>
                                <div className="text-center text-lg-start">
                          ...
                          <div className="col-12 swiper-slide">
                            <div className="d-flex justify-content-center gap-2">
                              <div className="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-4">
                                <div className="text-center text-lg-start"><img className="card-image rounded-circle object-fit-cover" src={UserReview4} alt="" /></div>
                                <div className="text-center text-lg-start">
                          ...
                          <div className="col-12 swiper-slide">
                            <div className="d-flex justify-content-center gap-2">
                              <div className="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-5">
                                <div className="text-center text-lg-start"><img className="card-image rounded-circle object-fit-cover" src={UserReview5} alt="" /></div>
                                <div className="text-center text-lg-start">
