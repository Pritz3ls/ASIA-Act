...
import WaveVariant2 from '../assets/img/illustrations/Wave_2.svg'

// Video Related
import Video from '../assets/video/Tech_video.mp4'
import VideoPlay from '../assets/img/illustrations/play-solid.svg'
import VideoPause from '../assets/img/illustrations/pause-solid.svg'

// SVG
import IcoRoadMap from '../assets/img/icons/roadmap.svg'
import IcoUsers from '../assets/img/icons/users-wm.svg'
import IcoShare from '../assets/img/icons/share-91.svg'
import IcoMeeting from '../assets/img/icons/video_meeting.svg'
import IcoOpeningTime from '../assets/img/icons/opening-times.svg'
import IcoFavorites from '../assets/img/icons/card-favorite.svg'
    ...
    return(
        <section className="experience position-relative overflow-hidden" id="service">
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-12">
                  <div className="position-relative z-1 text-center mb-8 mb-lg-9 video-player-paused" data-video-player-container="data-video-player-container"><video className="w-100 h-100 rounded-4" src={Video} poster={Experiences} type="video/mp4" data-video-player="data-video-player"></video>
                    <div className="overlay position-absolute top-0 bottom-0 start-0 end-0 rounded-4 bg-1100 object-cover" data-overlay="data-overlay"> </div><button className="btn play-button position-absolute justify-content-center align-items-center bg-white rounded-circle cursor-pointer" data-play-button="data-play-button"> <img className="play-icon w-25" src={VideoPlay} alt="" data-play-icon="data-play-icon" /><img className="pause-icon w-25" src={VideoPause} alt="" data-pause-icon="data-pause-icon" /></button>
                ...
                <div className="col-12">
                  <div className="row gy-4 g-md-3 pb-8 pb-lg-11 px-1">
                    <div className="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={IcoRoadMap} alt="" />
                      <div>
                    ...
                    <div className="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={IcoUsers} alt="" />
                      <div>
                    ...
                    <div className="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={IcoShare} alt="" />
                      <div>
                    ...
                    <div className="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={IcoMeeting} alt="" />
                      <div>
                    ...
                    <div className="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={IcoOpeningTime} alt="" />
                      <div>
                    ...
                    <div className="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={IcoFavorites} alt="" />
                      <div>
            ...
            <div className="position-absolute top-0 start-0 end-0">
              <div className="bg-white py-3 py-md-9 py-xl-10"> </div><img className="wave" src={WaveVariant2} alt="" />
            </div>
        </section>
    )
}
